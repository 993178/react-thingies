...
import { Route, NavLink, Switch, Redirect } from 'react-router-dom'; // Link is ipv <a>, omdat als je gewone a's gebruikt voor je links in de header, er een request wordt gestuurd en de pagina dus opnieuw laadt, en dat wil je niet want dan ben je je state ook kwijt
        ...
        return (
            <div className="Blog">
                ...
                <Switch>
                    ...
                    <Redirect from="/" to="/posts" /> {/* Redirect om gebruikers van een niet-bestaande (maar wel logische) link door te sturen naar iets wat wel bestaat. Je kunt dit ook buiten de Switch zetten en de from weglaten, dan wordt alles wat niet in de switch staat dus daarheen geleid */}
                </Switch>
            </div>
        );
    }
